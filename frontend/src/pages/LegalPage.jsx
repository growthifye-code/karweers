...
const DOCS = {
  privacy: {
    ...
    sections: [
      ["Data we collect", "Contact details you submit (name, email, phone, company), consultation enquiry content, newsletter email, and payment metadata processed by our payment provider. We do not store your card details — these are handled entirely by Stripe."],
      ["How we use it", "To respond to enquiries, deliver and schedule consultations, process payments, send booking confirmations and (with consent) our newsletter. We never sell your data."],
      ["Legal basis (GDPR)", "We rely on consent (newsletter, cookies), contract performance (consultations you book) and legitimate interest (responding to enquiries, securing our services)."],
      ["Your rights", "You have the right to access, rectify, erase, restrict, port and object to processing of your data, and to withdraw consent at any time. To exercise any right, email " + CONTACT.email + " and we will respond within 30 days."],
      ["Data retention", "We retain enquiry and booking data only as long as necessary for the purpose collected or as required by law, after which it is securely deleted."],
      ...
      ["Cookies", "We use only essential cookies for authentication and preferences. Analytics are anonymised. You can control cookies via your browser."],
